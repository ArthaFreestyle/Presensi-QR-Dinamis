import { Activity, CircleCheckBig, FlaskConical, House, LayoutDashboard, MapPin, QrCode } from "lucide-react";
...
export const dockApps: DockApp[] = [
  ...
  { id: "accelerometer", name: "Accel", href: "/tracking/accelerometer", icon: Activity },
