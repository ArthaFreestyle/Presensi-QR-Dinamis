import { CircleCheckBig, House, LayoutDashboard, MapPin, QrCode, Activity } from "lucide-react";
...
export const dockApps: DockApp[] = [
  ...
  { id: "accelerometer", name: "Accelerometer", href: "/tracking/accelerometer", icon: Activity },
];